#ifndef PARTICLE_INTERACTION_HARD_SPHERES_H
#define PARTICLE_INTERACTION_HARD_SPHERES_H
...
class particle_interaction_hard_spheres : public particle_interaction {
	...
	public:
		particle_interaction_hard_spheres(JRand_dyn *i_rand_1, double i_polydispersity) {
		...
		~particle_interaction_hard_spheres() {;}
