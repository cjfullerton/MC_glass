#include "calc__q6__sticky__1000.h"
...
int main(int argc, char *argv[]){
	...
	particle_interaction_sticky_spheres *int_poly_sticky_1 = new particle_interaction_sticky_spheres(1.030928, 1.0 ,0.0, rand_1);
	...
	sys_info__q6_calc *calc_q6 = new sys_info__q6_calc();
	calc_q6->box_ti_in(box_ti);

	slice  = 0;

	while(slice < final_slice - 1) {

		calc_q6->q6_cor(0.01, box_ti->r_box_size(0)/2.0, 0, "");
